...
export function NavbarComponentDefault() {
  ...
  return (
    <nav className="fixed z-40 lg:h-20 h-16 w-full bg-gradient-to-r from-blue-700 via-blue-700 to-blue-700 flex justify-center shadow-lg">
      <div className="w-11/12 h-full flex justify-between items-center text-white">
        <div className="logo">
          <h1 className="text-xl font-bold">MANTRA | APPS</h1>
        </div>
