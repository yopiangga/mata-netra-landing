...
import phone from "src/assets/img/phone-screen.png";
      ...
      <div className="w-10/12 pt-16 pb-10 grid lg:grid-cols-2 grid-cols-1">
        <div className="text">
          ...
          <p className="mt-7 text-sm text-slate-600">
            ...
            menentukan arah. MANTRA diharapkan dapat membantu para penyandang
            tunanetra low vision.
          </p>
          <p className="mt-7 text-sm text-slate-600">
            Diharapkan dapat membantu penyandang tunanetra low vision dalam
            menentukan arah tanpa harus salah memilih tujuan.
          </p>
          <a
            href={pathDownload}
            onClick={action}
            download
            className="mt-10 block bg-gradient-to-r from-blue-600 via-blue-600 to-blue-600 rounded-md py-4 px-12 w-fit text-white text-xs font-medium"
          >
            Unduh
          </a>
        </div>
...
export function CallToActionComponentText({ pathDownload, action }) {
  return (
    <div className="flex justify-center bg-gradient-to-r from-blue-600 via-blue-600 to-indigo-600">
